...
const en: Dict = {
  ...
  "login.loading": "Loading the demo citizen…",
  "login.errorTitle": "Tax Mitra API is unavailable",
  "login.errorBody": "We could not load the fictional demo data. Check that the API is running, then try again.",
  "login.retry": "Try again",
  "login.empty": "No demo citizens are available right now.",
  ...
  "j.finalWhere": "Where",
  "j.finalBoundary": "Tax Mitra has not submitted your response. Nothing has been sent to the Income Tax Department.",
...
const hi: Dict = {
  ...
  "landing.gpt.col2": "ChatGPT",
  "landing.gpt.col3": "Tax Mitra",
  "landing.gpt.1": "उलझन भरा, तकनीकी, पर���शान करने वाला",
  ...
  "login.loading": "डेमो नागरिक लोड हो रहा है…",
  "login.errorTitle": "Tax Mitra API उपलब्ध नहीं है",
  "login.errorBody": "काल्पनिक डेमो डेटा लोड नहीं हो सका। API चालू है या नहीं जाँचें, फिर दोबारा कोशिश करें।",
  "login.retry": "दोबारा कोशिश करें",
  "login.empty": "अभी कोई डेमो नागरिक उपलब्ध नहीं है।",
  ...
  "j.qHelp": "आपके जवाब आपका व्यक्तिगत मार्ग तय करते हैं। कोई गलत जवाब नहीं — \"मुझे पक्का नहीं है\" हमेशा चलेगा।",
  "j.next": "आगे बढ़ें",
  "j.back": "पीछे",
  ...
  "j.finalWhere": "कहाँ",
  "j.finalBoundary": "Tax Mitra ने आपका उत्तर जमा नहीं किया है। आयकर विभाग को कुछ भी नहीं भेजा गया है।",
